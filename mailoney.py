...
parser.add_argument('-d',action='store_true', help='adds the date string to the end of banner' )
parser.add_argument('-b',action='store', metavar='<banner>', default=None, help='The bannar after servername')
parser.add_argument('-s-id', action='store', metavar='<server id>', help='The server identificator in Log', default=None)
